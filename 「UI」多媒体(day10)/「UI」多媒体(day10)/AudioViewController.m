...
@property (retain, nonatomic) NSMutableArray *audioNameList;
...
- (void)viewDidLoad
{
    ...
    [self initPlayerWithAudioName:_audioNameList[0] shouldAutoPlay:_playing];
...
- (void)initDataSource
{
    _audioNameList = [[[NSMutableArray alloc]initWithObjects:
                      @"Deemo Title Song - Website Version",
                      @"Release My Soul",
                      @"Rё.L",
                       @"Wings of piano", nil] retain];
}
