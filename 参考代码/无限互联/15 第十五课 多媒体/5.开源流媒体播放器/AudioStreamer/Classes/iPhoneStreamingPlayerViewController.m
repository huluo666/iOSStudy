...
- (void)viewDidLoad
{
	...
	btn.frame = CGRectMake(50, 260, 100, 50);
	[btn setTitle:@"httpResume" forState:UIControlStateNormal];
	[btn addTarget:self action:@selector(btnActionT) forControlEvents:UIControlEventTouchUpInside];
	[self.view addSubview:btn];
	
	UIButton *btn2 = [UIButton buttonWithType:UIButtonTypeRoundedRect];
	btn2.frame = CGRectMake(200, 260, 100, 50);
	[btn2 setTitle:@"httpPause" forState:UIControlStateNormal];
	[btn2 addTarget:self action:@selector(btnActionT2) forControlEvents:UIControlEventTouchUpInside];
	[self.view addSubview:btn2];
	
}

-(void)btnActionT {
//	streamer.state = AS_INITIALIZED;
//	[streamer start];
	
	streamer.networkUse = YES;
