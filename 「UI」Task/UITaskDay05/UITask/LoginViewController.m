...
- (void)processController:(UIControl *)sender
{
    ...
    else if ([sender isKindOfClass:[UIButton class]])
    {
        ...
        [self performSelector:@selector(checkingLogin) withObject:activityIndicatorView afterDelay:0.5f];
    }
}
...
- (void)checkingLogin
{
    ...
    {
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"用户名或者密码错误" delegate:Nil cancelButtonTitle:@"返回重试" otherButtonTitles:nil];
        [alertView show];
        [alertView release];
    }
}
